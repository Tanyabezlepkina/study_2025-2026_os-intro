...
Программа для удобства работы в консоли 
...
Подготовка директории для конфигурации Sway 

![Создается структура директорий для пользовательских конфигурационных файлов.](image/8.png){#fig:008 width=70%}

---

Редактирование файла, который будет отвечать за настройки клавиатуры в Sway 
...
Установка pandoc и pandoc-crossref вручную 

![Скачаем необходимые версии](image/12.png){#fig:012 width=70%}

---

Для генерации PDF-файлов из Markdown через Pandoc требуется система верстки LaTeX 

![Установка дистрибутива TeXlive](image/13.png){#fig:013 width=70%}

---

Домашнее задание,выполняется сбор информации о системе с помощью команд dmesg для фиксации итоговой конфигурации 

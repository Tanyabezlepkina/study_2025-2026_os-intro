...
В рабочей директории курса через тектовый редактор файла открываю шаблон (рис. -@fig:004)

![Редактирование отчета](image/4.png){#fig:004 width=70%}

Указываю основную информацию о лабораторной работе (рис. -@fig:001)

![Заполнение основной информации](image/1.png){#fig:001 width=70%}

Формирую цель работы,задание и заполняю теоритическое введение (рис. -@fig:002) 

![Цель работы,задание и теоретическое введение](image/2.png){#fig:002 width=70%}

Описываю процесс выполнения лабораторной работы (рис. -@fig:003)

...
Объект — операционная система Linux и её инструменты командной строки. Предмет — методы безопасного удаленного доступа, управления пакетами и процессами, а также биоинформатические инструменты для анализа последовательностей ДНК.

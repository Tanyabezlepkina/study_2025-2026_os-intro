...
Операционная система Linux является фундаментом современной IT-инфраструктуры. Она используется на серверах, в облачных технологиях, встраиваемых системах и средах разработки. Умение работать в командной строке Linux — обязательный навык для системного администратора, разработчика и DevOps-инженера. Изучение основ работы в терминале, файловой системы, перенаправления ввода-вывода, поиска файлов и текста, а также архивации данных позволяет эффективно выполнять повседневные задачи без использования графического интерфейса.

# Объект и предмет исследования.

1. Объект исследования — операционная система Linux (дистрибутив Fedora) и её командная оболочка (bash).

2. Предмет исследования — базовые инструменты командной строки Linux: навигация по файловой системе (`cd`, `ls`, `pwd`), управление файлами и каталогами (`touch`, `mkdir`, `cp`, `mv`, `rm`), перенаправление ввода-вывода (`>`, `>>`, `<`, `|`), поиск файлов (`find`) и текста (`grep`), а также работа с архиваторами (`tar`, `gzip`, `zip`).

# Научная новизна. 

Работа имеет учебно-методический характер. Научная новизна заключается в систематизации практических приёмов работы с основными командами Linux применительно к типовым задачам: навигация, управление файлами, фильтрация данных, поиск и архивация. Результаты работы могут быть использованы в качестве методического материала для начинающих пользователей Linux.

# Практическая значимость работы. 

Освоенные в ходе работы навыки могут быть применены в реальной практической деятельности. Умение работать в командной строке позволяет:
- быстро перемещаться по файловой системе и управлять файлами без использования графического интерфейса;
- эффективно искать файлы и текстовую информацию с помощью `find` и `grep`;
- обрабатывать данные с использованием конвейеров и перенаправления ввода-вывода;
- архивировать и распаковывать файлы и директории.
Полученные знания являются фундаментом для дальнейшего изучения администрирования Linux, написания bash-скриптов и автоматизации задач.
...
![Какая ОС используется?](image/1.png){#fig:001 width=50%}
...
![Что такое виртуальная машина?](image/2.png){#fig:002 width=50%}
...
![Создание документа Hello.xml](image/3.png){#fig:003 width=50%}
...
![Расширение пакетов в Ubuntu](image/4.png){#fig:004 width=50%}
...
![Установка VLC и фамилия автора ](image/5.png){#fig:005 width=50%}
...
![Назначение Update Manager](image/6.png){#fig:006 width=50%}
...
![Синонимы командной строки](image/7.png){#fig:007 width=50%}
...
![Команда pwd](image/8.png){#fig:008 width=50%}
...
![Команда ls с опциями](image/9.png){#fig:009 width=50%}
...
![Вывод содержимого ~/Downloads](image/10.png){#fig:010 width=50%}
...
![Удаление директорий](image/11.png){#fig:011 width=50%}
...
![Запуск программы](image/14.png){#fig:014 width=50%}

---

Почему выбран ответ: Поток ошибок stderr по умолчанию выводится на экран (терминал), так же как и stdout

![Вывод stderr по умолчанию](image/15.png){#fig:015 width=50%}
...
![Запись stderr в файл](image/16.png){#fig:016 width=50%}
...
![grep «world» ](image/25.png){#fig:025 width=50%}
...
![Поиск строк с love у Шекспира](image/26.png){#fig:026 width=50%}
